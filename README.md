...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fzm6ts.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fzm6ts.containers.anotherwebservice.com/
...
```
git clone git@github.com:mobin-mazahery-school/container-fzm6ts.git
cd container-fzm6ts
```
...
```
docker attach container-fzm6ts
```
